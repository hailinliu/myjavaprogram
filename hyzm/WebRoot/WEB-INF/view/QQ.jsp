...
<title>卫视文化乐园-华豫之门官方网站QQ账号登陆</title>
	...
	<script type="text/javascript" src="<c:url value='/js/alert.js'/>"></script>
	  <script type="text/javascript" src="http://qzonestyle.gtimg.cn/qzone/openapi/qc_loader.js" data-appid="101198326" data-redirecturi="http://work.wswhly.com/hyzm/redirect?p=QQ" charset="utf-8"></script>
  </head>
...
<script type="text/javascript">
		   //从页面收集OpenAPI必要的参数。get_user_info不需要输入参数，因此paras中没有参数
			...
			QC.api("get_user_info", paras)
				...
				.success(function(s){
				$('#username').val(s.data.nickname+Math.floor(Math.random()*10000000));
				...
				QC.Login.getMe(function(openId, accessToken){
					...
					$('#openId').val('qq_'+openId);
					checkopenId('qq_'+openId);
