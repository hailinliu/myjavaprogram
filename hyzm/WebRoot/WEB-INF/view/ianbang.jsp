...
<html>
  <head>
    ...
    <title>安邦保险合作_卫视文化乐园-华豫之门官方网站</title>
...
<div style="position:relative;">
    ...
    <div class="tp" style="position:relative;z-index:100;background:url(images/ianbang/ianbang_01.jpg) no-repeat center 0;width:100%;height:860px;">

    </div>
    <div class="tp" style="position:relative;z-index:100;background:url(images/ianbang/ianbang_02.jpg) no-repeat center 0;width:100%;height:384px;">

    </div>

    <div class="tp" style="position:relative;z-index:100;background:url(images/ianbang/ianbang_03.jpg) no-repeat center 0;width:100%;height:1636px;">

    </div>
    <div class="tp" style="position:relative;z-index:100;background:url(images/ianbang/ianbang_04.jpg) no-repeat center 0;width:100%;height:1520px;">
            <a href="http://www.anbanggroup.com/index.html" target="_blank" style="background:none;display:block;width:100%;height:100%;z-index:999;"></a>
    </div>
