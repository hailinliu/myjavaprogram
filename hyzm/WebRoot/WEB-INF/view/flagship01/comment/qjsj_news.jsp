 ...
 <!-- 商家动态 -->
	<div class="sjtit_news">
          ...
          <ul>
              ...
              <li>
                  <a href="<c:url value='/redirect?p=flagship01/qjsj_onenews02'/>" target="_blank" class="fl">书拨：古代文人优雅翻书小物件</a>
                  <span class="">2014-09-29</span>
              </li>
              <li>
              ...
              <li>
                  <a href="<c:url value='/redirect?p=flagship01/qjsj_onenews04'/>" target="_blank" class="fl">似曾相识的异国文物</a>
                  <span class="">2014-09-10</span>
              </li>
              <li>
                  <a href="<c:url value='/redirect?p=flagship01/qjsj_onenews05'/>" target="_blank" class="fl">流失海外中国文物返还阻碍多 将建被盗文物数据库</a>
                  <span class="">2014-09-10</span>
              </li>
            </ul>
        </div>
