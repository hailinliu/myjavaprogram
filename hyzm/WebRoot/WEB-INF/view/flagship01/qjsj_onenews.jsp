...
<jsp:include page="../banner/banner.jsp"></jsp:include>
    ...
    <div class="qjsj_left fl" style="width: 810px;">
        <div class="qj_video_head">
            ...
            <span class="fl">&nbsp;>&nbsp;</span>
            <a href="<c:url value='/redirect?p=flagship/qjsj_details'/>" target="_blank" class="fl">商家动态</a>
            <span class="fl">&nbsp;>&nbsp;</span>
            <a href="<c:url value='/redirect?p=flagship/qjsj_video'/>" target="_blank" class="fl mianbao_tit">竹雕的收藏与保养</a>
        ...
        <div class="sjnew_box nr_box clear">
          ...
          <div class="sjnew_cont sczx_nr">
            <p>
            器物表面产生污垢时，不可用肥皂、肥皂粉和清洁剂之类的化学品洗刷，而应该用柔软的绒布轻轻擦拭，持之以恒，做到经常化，这样可以保持其表面光亮润泽。若遇陈年积垢，用绒布擦拭难以奏效，不妨汲取适量的绍兴黄酒或桐油做擦拭剂，这样既清除顽垢，又起到了保护作用。
            <br>器物表面产生污垢时，不可用肥皂、肥皂粉和清洁剂之类的化学品洗刷，而应该用柔软的绒布轻轻擦拭，持之以恒，做到经常化，这样可以保持其表面光亮润泽。若遇陈年积垢，用绒布擦拭难以奏效，不妨汲取适量的绍兴黄酒或桐油做擦拭剂，这样既清除顽垢，又起到了保护作用。
            </p>
            <p><img src="images/flagship/shop_name.jpg" align="center" /></p>
            <p>
            器物表面产生污垢时，不可用肥皂、肥皂粉和清洁剂之类的化学品洗刷，而应该用柔软的绒布轻轻擦拭，持之以恒，做到经常化，这样可以保持其表面光亮润泽。若遇陈年积垢，用绒布擦拭难以奏效，不妨汲取适量的绍兴黄酒或桐油做擦拭剂，这样既清除顽垢，又起到了保护作用。
            <br>器物表面产生污垢时，不可用肥皂、肥皂粉和清洁剂之类的化学品洗刷，而应该用柔软的绒布轻轻擦拭，持之以恒，做到经常化，这样可以保持其表面光亮润泽。若遇陈年积垢，用绒布擦拭难以奏效，不妨汲取适量的绍兴黄酒或桐油做擦拭剂，这样既清除顽垢，又起到了保护作用。
            </p>
          ...
          <!-- 分享。。。 -->
            ...
            <ul class="next_list">
                ...
                <li>
                     <span class="content fl">
                       <a href="/hyzm/news/getOneNews?id=997">下一篇</a>
                     </span>
                     <span class="headline fl">
