...
<div class="banner_hb" style="margin-bottom:20px;"></div>

<!--main style ben-->
<div class="main_box clear pmjg">
	<!-- 标题 -->
	<div class="tit_box">
		<p class="fl pmjg_tit">拍卖机构	</p>
		<p class="fl" style="margin-left:20px;">|</p>
		<a href="#" class="fl">国外拍卖机构</a>
		<p class="fl" style="margin-left:20px;">|</p>
		<a href="#" class="fl">国内拍卖机构</a>
		<p class="fr">当前共有<span class="jg_shuliang">&nbsp;5&nbsp;</span>家拍卖机构</p>
	</div>
	<!--苏富比 -->
	<div class="jg_box">
		<div class="fl img">
			<a href="<c:url value='/redirect?p=Auction/getAuctionsinfo'/>" target="_blank">
				<img src="<c:url value='/images/getAuction/sfb.jpg'/>"/>
			</a>
		</div>
		<div class="fr txt">
			<h3><a href="<c:url value='/redirect?p=Auction/getAuctionsinfo'/>" target="_blank">苏富比</a></h3>
			<p class="jgjs">苏富比(Sotheby's ）与克里斯蒂（又译作佳士得）拍卖行、菲利普拍卖行并称为全球三大拍卖行。苏富比业务遍及全球40个国家，包括北京、莫斯科及多哈等新兴市场；主要拍卖中心设在美国纽约约...
				<a href="<c:url value='/redirect?p=Auction/getAuctionsinfo'/>" target="_blank">[详细]</a>
			</p>
			<dl>
				<dt class="fl">电话：</dt>
				<dd class="fl">111</dd>
	...
	<div class="jg_box">
		...
		<div class="fr txt">
			<h3><a href="<c:url value='/redirect?p=Auction/getAuctionsinfo'/>" target="_blank">佳士得</a></h3>
	...
	<div class="jg_box">
		...
		<div class="fr txt">
			<h3><a href="<c:url value='/redirect?p=Auction/getAuctionsinfo'/>" target="_blank">嘉德</a></h3>
	...
	<div class="jg_box">
		...
		<div class="fr txt">
			<h3><a href="<c:url value='/redirect?p=Auction/getAuctionsinfo'/>" target="_blank">保利</a></h3>
	...
	<div class="jg_box">
		...
		<div class="fr txt">
			<h3><a href="<c:url value='/redirect?p=Auction/getAuctionsinfo'/>" target="_blank">瀚海</a></h3>
