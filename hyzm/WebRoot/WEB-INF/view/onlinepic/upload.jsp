...
<html>
  ...
  <head>
    ...
    <title>图片鉴定_卫视文化乐园-华豫之门官方网站</title>
...
var settings = {
  ...
  swfupload = new SWFUpload(settings);
  	...
  	//验证余额a
	 if(check()==0){
	 	$("#nomoney").html("<a href='<c:url value='/redirect?p=/mine/recharge1'/>'><font color='red' style='font-size:20px'>尊敬的用户您余额不足,请先充值！</font></a>");
	 }
});
...
function submit(){
	if(check()==1){
		...
		//var zjuserid=$('input[name=zjuserid]:checked').val();
		var name=$("#name").val();
		var pic=$("#imgid").val();
		var size=$("#size").val();
		var note=$("#note").val();
...
<div class="main_box clear" style="margin-top:10px;background:#fff;box-shadow:1px 2px 10px #ccc;position:relative;">
    ...
    <div class="pp_txt">
        ...
        <p style="">
          <span>尺寸/重量：</span>
          <span class="pp_button">
          <input id="size" style="height: 27" type="text" name="size" maxlength="300" value="" placeholder="" />
          </span>
          <span class="huise" style="margin-left:14px;">
        <i class="red">* 必填</i>
      </span>
        ...
        <p style="overflow:hidden;">
          ...
          <span class="text_box fl">
            <textarea name="note" id="note" value="" cols="30" rows="10" style="height:80px;"></textarea>
            <br /><br />* 为了能更准确的帮您的藏品进行估值，请对藏品的品相做准确的描述。
          </span>
          <span class="huise" style="margin-left:14px;"> <i class="red">* 必填</i>
          </span>

        </p>
    </div>

    <div style="font-size:16px;padding-left:45px;padding-right:45px;color:red;line-height:40px;background:#F8F8F8;margin-top:15px;">
      ...
      <p style="text-indent:5em;width:300px;" class="pic_sm">●&nbsp;&nbsp;<a href="javascript:void(0)" >查看上传图片规格须知</a>
      </p>
    ...
    <div class="up_pics">
        ...
        <div class=" up_box fl" style="">
           <div class="fl" id="upupup1" style="padding-left:20px;padding-top:20px;">
            ...
            <div class="shili_img fr" id="shili_img2">
