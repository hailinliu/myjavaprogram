...
<html>
  <head>
	...
	<meta name=keywords content="资讯，收藏资讯，拍卖资讯，业界动态，评论分析，展览资讯，珍品鉴赏，展览场馆，专题报道，华豫快讯，官网活动">
	<meta name=description content="卫视文化乐园-华豫之门官方网站，收藏资讯包括多种多样的收藏信息，">
  </head>
...
<div class="main_box clear">
  ...
  <div class="mian_left clear">
    ...
    <div class="zx_box clear">
       ...
       <div class="zx_nr">
         ...
         <div class="tu_pic"><a href="<c:url value='/collection/${col.id}.dhtml'/>" target="_blank"><img src="<%=PropertiesUtil.getPropertiesValue("collectionurl")%>small/${col.imgurl}" alt="${col.name}" /></a><p><a href="<c:url value='/collection/${col.id}.dhtml'/>" target="_blank">${col.name}</a></p></div>
  ...
  <div class="mian_right clear">
     <ul class="zxjh_list clear">
         <li>
             <div class="tit_box"><span class="fl"><img src="<c:url value='/images/pmzx_pic.jpg'/>" alt="拍卖资讯" /></span><span class="more fr"><a href="<c:url value='/news/getCollectionInfoByStyle'/>?style=101&currentPage=1&pageSize=10" target="_blank">更多 &gt;&gt;</a></span></div>
             <div class="zxjh_nr">
                     ...
                     <c:forEach items="${list1}" var="news" varStatus="ndn">
                        <c:choose>
                           <c:when test="${ndn.count eq 1}">
                     		   <li class="none_bg">
                     		     <p class="blod">
                     		       <a href="<c:url value='/news/${news.id}.dhtml'/>" target="_blank">${news.title}</a>
                     		     </p>
                     		     <p class="wz">
                     		       <c:choose>
                           ...
                           <c:when test="${ndn.count eq 7}">
	                           <li class="none"><a href="<c:url value='/news/${news.id}.dhtml'/>" target="_blank">${news.title}</a></li>
                           </c:when>
                           <c:otherwise>
         ...
         <li>
           <div class="tit_box"><span class="fl"><img src="<c:url value='/images/yjdt_pic.jpg'/>" alt="业界动态"/></span><span class="more fr"><a href="<c:url value='/news/getCollectionInfoByStyle'/>?style=102&currentPage=1&pageSize=10" target="_blank">更多 &gt;&gt;</a></span></div>
           <div class="zxjh_nr">
                <div class="fl hb_left3"><p class="hb_top"><img src="<c:url value='/images/hb_top_left.jpg'/>" alt="" /></p><p class="hb_botom"><img src="<c:url value='/images/bottom_left.jpg'/>" alt=""/></p></div>
                <div class="ask_nr fl">
                  <ul class="nr_list">
   ...
   <ul class="zxjh_list clear">
         <li>
             <div class="tit_box"><span class="fl"><img src="<c:url value='/images/zcjs_pic.jpg'/>" alt="珍藏鉴赏"/></span><span class="more fr"><a href="<c:url value='/news/getCollectionInfoByStyle'/>?style=103&currentPage=1&pageSize=10" target="_blank">更多 &gt;&gt;</a></span></div>
             <div class="zxjh_nr">
                <div class="fl hb_left3"><p class="hb_top"><img src="<c:url value='/images/hb_top_left.jpg'/>" alt=""/></p><p class="hb_botom"><img src="<c:url value='/images/bottom_left.jpg'/>" alt=""/></p></div>
                <div class="ask_nr fl">
                  <ul class="nr_list">
         ...
         <li>
           <div class="tit_box"><span class="fl"><img src="<c:url value='/images/plfx_pic.jpg'/>" alt="评论分析"/></span><span class="more fr"><a href="<c:url value='/news/getCollectionInfoByStyle'/>?style=104&currentPage=1&pageSize=10" target="_blank">更多 &gt;&gt;</a></span></div>
           <div class="zxjh_nr">
                <div class="fl hb_left3"><p class="hb_top"><img src="<c:url value='/images/hb_top_left.jpg'/>" alt=""/></p><p class="hb_botom"><img src="<c:url value='/images/bottom_left.jpg'/>" alt=""/></p></div>
                <div class="ask_nr fl">
                  <ul class="nr_list">
   ...
   <ul class="zxjh_list clear">
         <li>
             <div class="tit_box"><span class="fl"><img src="<c:url value='/images/zlzx_pic.jpg'/>" alt="展览资讯"/></span><span class="more fr"><a href="<c:url value='/news/getCollectionInfoByStyle'/>?style=105&currentPage=1&pageSize=10" target="_blank">更多 &gt;&gt;</a></span></div>
             <div class="zxjh_nr">
                <div class="fl hb_left3"><p class="hb_top"><img src="<c:url value='/images/hb_top_left.jpg'/>" alt=""/></p><p class="hb_botom"><img src="<c:url value='/images/bottom_left.jpg'/>" alt=""/></p></div>
                <div class="ask_nr fl">
                  <ul class="nr_list">
         ...
         <li>
           <div class="tit_box"><span class="fl"><img src="<c:url value='/images/zlcg_pic.jpg'/>" alt="展览场馆"/></span><span class="more fr"><a href="<c:url value='/news/getCollectionInfoByStyle'/>?style=106&currentPage=1&pageSize=10" target="_blank">更多 &gt;&gt;</a></span></div>
           <div class="zxjh_nr">
                <div class="fl hb_left3"><p class="hb_top"><img src="<c:url value='/images/hb_top_left.jpg'/>" alt=""/></p><p class="hb_botom"><img src="<c:url value='/images/bottom_left.jpg'/>" alt=""/></p></div>
                <div class="ask_nr fl">
                  <ul class="nr_list">
