...
<html>
  <head>
	...
	<meta name=keywords content="华豫快讯">
	<meta name=description content="华豫快讯">
  </head>
...
<div class="mian_right clear">
     <div class="zxlb_pic" style="background: url(../images/hykx_bg.jpg);"><span class="bread_nav">当前位置：首页<span class="jt">></span>华豫快讯</span></div>
     <ul class="new_list">
