...
<div class="haixuan_ad" style="margin:20px auto;height:490px;">
...
<div class="haixuan_content">
  ...
  <div class="zjjs" name="zjjs" id="zjjs" style="height:auto;padding-bottom:15px;">
    ...
    <div class="road_sm">
      <ul class="road_ul">
          <li class="road_tit">北京火车站</li>
            <li class="road_con">从北京火车站东行350米，乘坐938路公交车，即可直达"国安第一城"；</li>
        </ul>
        <ul class="road_ul">
          <li class="road_tit">地铁10号线</li>
            <li class="road_con"> 坐地铁10号线到“十里河”站下车，出A口后继续前行到首都图书馆门口，乘坐"国安第一城"爱心大巴即可到达。
</li>
        </ul>
        <ul>
          <li class="road_tit">自驾路线</li>
            <li class="road_con">自驾车从东四环上京哈高速（原京沈高速），西集出口（35号出口）下高速出收费站右转，沿觅西路到觅子路左转，即可到达"国安第一城"；
...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(116.922688,39.723544);//定义一个中心点坐标
  ...
  map.addControl(ctrl_sca);
    ...
    //标注点数组
    var markerArr = [{title:"国安第一城",content:"我的备注",point:"116.913364|39.72292",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
     ,{title:"酒店",content:"酒店",point:"116.913058|39.722698",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
     ,{title:"酒店",content:"酒店",point:"116.918376|39.725986",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
     ];
    //创建marker
    function addMarker(){
