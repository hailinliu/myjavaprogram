...
<html>
  ...
  <body>
	                            ...
	                            <!--  左半部分-->
	<div class="pmjg_left fl">
		<div class="jg_left_img">
			<img src="<c:url value='/images/getAuction/sfb2.jpg'/>"/>
		</div>
		<div class="jg_left_jianjie">
			<span>商家简介</span>
			<p>
				1744年3月初，英国伦敦有一处叫“科芬园”的地方。那里一直是果菜和花卉市场，而当时却成了一个书籍拍卖会的举行地点。主办者一位叫山米尔·贝克的书商。
书籍拍卖会共举行了十天。白天，买家可以欣赏和浏览准备拍卖的书籍，夜幕降临，拍卖官司开始主持叫价...
			</p>
		</div>
		<div class="jg_left_txt">
			<span>联系方式</span>
			<p>地址：东方之珠</p>
			<p>电话：123455555</p>
		</div>
