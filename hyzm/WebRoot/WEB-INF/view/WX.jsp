...
<title>卫视文化乐园-华豫之门官方网站微信账号登陆</title>
...
<jsp:include page="foot/footer.jsp"></jsp:include>
 <% 
     try{
	  ...
	  GetMethod get = new GetMethod("https://api.weixin.qq.com/sns/oauth2/access_token?appid=wxab49c0333cba7cd1&secret=f5f1f37d3b411d8c0c0d7fad37f3f522&code="+request.getParameter("code")+"&grant_type=authorization_code");
	...
	HttpClient client1 = new HttpClient();
	  client1.getParams().setParameter(HttpMethodParams.HTTP_CONTENT_CHARSET, "utf-8");
	  GetMethod get1 = new GetMethod("https://api.weixin.qq.com/sns/userinfo?access_token="+map.get("access_token")+"&openid="+map.get("openid")+"&lang=zh_CN");
	  client1.executeMethod(get1);
	  String result1 = get1.getResponseBodyAsString();
	  JSONObject info1 = JSONObject.fromObject(result1);
      ...
      <script type="text/javascript">
				 $(function(){
				 	...
				 	return ;
		   			...
		   			$('#username').val('<%=map1.get("nickname")%>'+Math.floor(Math.random()*10000000));
					$('#openId').val('wx_<%=map.get("openid")%>');
					checkopenId('wx_<%=map.get("openid")%>');
				 });	
