...
<html>
  ...
  <script type="text/javascript">
    // 判断登陆
      function pnlogin(ids) {
        ...
        if('${CurrentSession}' == ''){
              alert("参与评论，请先登录");
              location.hash = "<c:url value='/redirect?p=login'/>";
              return false;
         }else{
              location.hash="<c:url value='/proficient/getProficient?id='/>"+ids+"#pl0";
         }
 ...
 $(function(){
  ...
  <h1>海选报名流程 </h1>
    ...
    <img src="<c:url value='/images/qtsimg/hxbmxBj.jpg'/>" width="100%" style="display: block;"/>
