...
<html>
  <head>
    ...
    <title>图片鉴定改版_卫视文化乐园-华豫之门官方网站</title>
  ...
  <link rel="stylesheet" type="text/css" href="<c:url value='/css/vip.css'/>"/>
	...
	<meta name=keywords content="图片鉴定改版">
	<meta name=description content="卫视文化乐园-华豫之门官方网站图片鉴定改版">
...
<div style="position:relative;width:100%;">
    ...
    <div class="tp" style="position:relative;z-index:100;background:url(images/viplever/gaib01.jpg) no-repeat center 0;width:100%;height:827px;">

            <div style="position:relative;width:1140px;height:827px;margin:0 auto;">
                <a href="<c:url value='/onlinepic/gotoonlinepicindex'/>"  target="_bank" style="background:none;display:block;width: 351px;
height: 135px;
position: absolute;
top: 603px;
right: 10px;
...
">
    ...
    <div class="tp" style="position:relative;z-index:100;background:url(images/viplever/gaib02.jpg) no-repeat center 0;width:100%;height:1045px;">

    </div>

    <div class="tp" style="position:relative;z-index:100;background:url(images/viplever/gaib03.jpg) no-repeat center 0;width:100%;height:928px;">
...
<div class="user_right" style="margin:20px auto;width:890px;height:680px;overflow:hidden;display:none">
   <div class="onuser_tit2" style="margin-bottom:40px">会员等级介绍</div>
       ...
       <div class="fd_jianding bg"  style="display:none"><p>华豫海选时，在短信预约的鉴定时间内，专享官网星级会员通道直达专家面前，快速便捷完成鉴定。
</p></div>
