...
<jsp:include page="../head/header.jsp"></jsp:include>
  <head>
    ...
    <title>藏品上传_会员藏品区_卫视文化乐园-华豫之门官方网站</title>
	...
	<meta name=keywords content="会员藏品上传">
	<meta name=description content="卫视文化乐园-华豫之门官方网站会员藏品上传">
...
function gotoUpload() {
	location.href = "<c:url value='/vote/gotovipupload'/>";
}
...
var id = $('#uploadcollectionid').val();
		//alert(memo);
$.ajax({type: "POST",
      dataType: "text",
      url: "<c:url value='/vote/uploadCollectionMsg'/>",
      data: {id:id, typeid:typeid,imgurl:imgurl,name:name,memo:memo, type:4},
      success:function(data){
        if(data == "0000"){
         alert("操作成功！");
         location.href = "<c:url value='/vote/myVipRelease'/>";
        }else{
          alert(data);
        }
      }
	    ...
	    <div class="content_s" style="width:1140px;">
	    	...
	    	<div class="main_box clear">
				...
				<div class="user_right fr clear" style="background:#fff;">
				     <div class="onuser_tit2">会员藏品发布</div>
				     <div class="onuser_box4 clear">
				        ...
				        <div class="bottom_line"></div>
				         ...
				         <input id="uploadcollectionid" type="hidden" name="id" value="${activity.id}"/>
				         <input id="imgid" type="hidden" name="imgurl" value="${activity.imgurl}"/>
				         <div class="upload_box clear">
				             <table width="100%" border="0" cellspacing="0" cellpadding="0">
				                          ...
				                          <li>
				                             <select id="typeid" name="type">
				                               ...
				                               <c:forEach items="${typeList}" var="type">
				                                 <option <c:if test="${activity.type eq type.id}">selected="selected"</c:if> value="${type.id}">${type.name}</option>
				                               </c:forEach>
				                             </select>
				                          </li>
				                ...
				                <tr>
				                  ...
				                  <td>
				                     <ul class="text_list">
				                       <li><input id="nameid" style="height: 27" type="text" name="name" maxlength="300" value="${activity.name}" placeholder="" /></li>
				                       <li>*1-20个汉字</li>
				                     </ul>
				                  </td>
				                </tr>
				              ...
				              <ul class="textarea_list">
				                 <li>收藏品介绍：(5000字以内)</li>
				                 <li>
				                   <textarea name="memo" id="memo" placeholder="">${activity.note}</textarea>
				                 </li>
				              </ul>
