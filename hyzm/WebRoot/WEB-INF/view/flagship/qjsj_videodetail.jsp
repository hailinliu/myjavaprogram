    ...
    <div class="qjsj_left fl" style="width: 810px;">
        ...
        <div class="sjnew_box nr_box clear">
        	<div class="title_box">
		       ...
		       <ul class="title_list">
		           <li>时间：${videoinfo.sfcreatedate}</li>
		           <li>点击：${videoinfo.clicknum}</li>
		           <li>标签：${videoinfo.label}</li>
		       </ul>
		     </div>
		    <p class="line"></p>
        ...
        <div class="video_qts">
            <h3 class="">相关视频：</h3>
             ...
             <c:forEach items="${videolistinfo}" var="info" varStatus="sta">
             <c:if test="${sta.index==0}"><li class="no_margin_lf"></c:if>
	         <c:if test="${sta.index==1||sta.index==3||sta.index==2}"><li></c:if>
	              <div class="qj_video_top"></div>
	              <img class="video_icon2" src="../images/zt0910_img/zt_butt.png">
	              <div class="lit_video">
	                <a href="#" target="_blank">
	                  <img src="${info.imgurltitle}" alt=""  width="200px" height="160px">
	              </a>
	              </div>
