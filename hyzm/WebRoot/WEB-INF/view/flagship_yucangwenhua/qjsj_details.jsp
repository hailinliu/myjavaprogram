        ...
        <ul class="qj_details_list">
            <li>
                <div class="details_name">
                  <p class="b"><a href="<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews01'/>" target="_blank">东南拍卖历年最强阵容登场</a></p>
                </div>
                ...
                <div class="qj_details_box">
                  <div class="fl qj_details_pics">
                    <a href="<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews01'/>" target="_blank">
                  ...
                  <div class="fr qj_details_txt">
                    ...
                    <button class="goto_more" onclick="window.open('<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews01'/>')">阅读全文</button>
                  </div>
                </div>
              </li>
              <li>
                <div class="details_name">
                  <p class="b"><a href="<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews02'/>" target="_blank">书拨：古代文人优雅翻书小物件 </a></p>
                </div>
                <div class="details_time">
                  <span class="clock fl"></span>
                  <span class="fl">09-29&nbsp;14:48</span>
                ...
                <div class="qj_details_box">
                  <div class="fl qj_details_pics">
                    <a href="<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews02'/>" target="_blank">
                  ...
                  <div class="fr qj_details_txt">
                    ...
                    <button class="goto_more" onclick="window.open('<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews02'/>')">阅读全文</button>
                  </div>
                </div>
              </li>
              <li>
                <div class="details_name">
                  <p class="b"><a href="<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews03'/>" target="_blank">佳士得将对超估价拍品加收2%佣金</a></p>
                </div>
                <div class="details_time">
                  <span class="clock fl"></span>
                ...
                <div class="qj_details_box">
                  <div class="fl qj_details_pics">
                    <a href="<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews03'/>" target="_blank">
                  ...
                  <div class="fr qj_details_txt">
                    ...
                    <button class="goto_more" onclick="window.open('<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews03'/>')">阅读全文</button>
                  </div>
                </div>
              </li>
              <li>
                <div class="details_name">
                  <p class="b"><a href="<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews04'/>" target="_blank">似曾相识的异国文物</a></p>
                </div>
                <div class="details_time">
                  <span class="clock fl"></span>
                ...
                <div class="qj_details_box">
                  <div class="fl qj_details_pics">
                    <a href="<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews04'/>" target="_blank">
                  ...
                  <div class="fr qj_details_txt">
                    ...
                    <button class="goto_more" onclick="window.open('<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews04'/>')">阅读全文</button>
                  </div>
                </div>
              </li>
              <li>
                <div class="details_name">
                  <p class="b"><a href="<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews05'/>" target="_blank">流失海外文物返还阻碍多 将建被盗文物数据库 </a></p>
                </div>
                <div class="details_time">
                  <span class="clock fl"></span>
                ...
                <div class="qj_details_box">
                  <div class="fl qj_details_pics">
                    <a href="<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews05'/>" target="_blank">
                  ...
                  <div class="fr qj_details_txt">
                    ...
                    <button class="goto_more" onclick="window.open('<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews05'/>')">阅读全文</button>
                  </div>
                </div>
              </li>
              <li>
                <div class="details_name">
                  <p class="b"><a href="<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews06'/>" target="_blank">庞能：藏友爱“钱”，取之有“道”</a></p>
                </div>
                <div class="details_time">
                  <span class="clock fl"></span>
                  <span class="fl">09-24&nbsp;14:48</span>
                ...
                <div class="qj_details_box">
                  <div class="fl qj_details_pics">
                    <a href="<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews06'/>" target="_blank">
                  ...
                  <div class="fr qj_details_txt">
                    ...
                    <button class="goto_more" onclick="window.open('<c:url value='/redirect?p=flagship_yucangwenhua/qjsj_onenews06'/>')">阅读全文</button>
                  </div>
                </div>
              </li>
