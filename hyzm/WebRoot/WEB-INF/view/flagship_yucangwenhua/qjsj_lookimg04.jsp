...
<jsp:include page="../banner/banner.jsp"></jsp:include>
    ...
    <div class="qjsj_left fl" style="width: 810px;">
        <div class="qj_video_head">
            ...
            <span class="fl">&nbsp;>&nbsp;</span>
            <a href="<c:url value='/redirect?p=flagship_xueyitang/qjsj_tuzhan'/>" target="_blank" class="fl">商家图展</a>
             <span class="fl">&nbsp;>&nbsp;</span>
            <span class="fl mianbao_tit">中华民国中花背双旗当五十铜元</span>
        ...
        <div class="sjnew_box nr_box clear">
          ...
          <div class="sczx_nr">
            ...
            <p><img src="<c:url value='/images/flagship/yucangwenhua/gangpai/HKYC01002-0.jpg'/>" alt="" /></p>
