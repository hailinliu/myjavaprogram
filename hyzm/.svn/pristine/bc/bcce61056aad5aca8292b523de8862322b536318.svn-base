          ...
          <li>
              ...
              <div class="qj_video_lispic">
                  <a href="<c:url value='/redirect?p=flagship_doubao/qjsj_onevideo01'/>" target="_blank">
                      <img src="<c:url value='/images/flagship/flagship_doubao/adsimg1/1.jpg'/>" alt="上海斗宝艺术展览有限公司">
                  </a>
              </div>
              <p>
                <a href="<c:url value='/redirect?p=flagship_doubao/qjsj_onevideo01'/>" target="_blank">上海斗宝艺术展览有限公司</a>
              </p>
          </li>
