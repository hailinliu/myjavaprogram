...
<jsp:include page="../head/header.jsp"></jsp:include>
  <head>
	...
	<meta name=keywords content="我的发布">
	<meta name=description content="我要上华豫-我的发布">
						...
						<ul class="cplist_ul">
                          ...
                          <c:choose>
                            <c:when test="${cdn.count % 4 == 0}">
								...
								<div class="cp_img">
								<a class="vo_imgs" href="<c:url value='/vote/${upload.id}.dhtml'/>">
						        <img src="<%=PropertiesUtil.getPropertiesValue("uploadVoteurl")%>/${upload.imgurl}" width="235" height="216"/>
						         </a>
									</div>
									<div class="cp_tit">
