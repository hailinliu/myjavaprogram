    ...
    <div class="qjsj_left fl" style="width: 810px;">
        <div class="qj_video_head">
            ...
            <a href="<c:url value='/redirect?p=flagship/qjsj_tuzhan'/>" target="_blank" class="fl">商家图展</a>
             <span class="fl">&nbsp;>&nbsp;</span>
            <a href="<c:url value='/redirect?p=flagship/qjsj_video'/>" target="_blank" class="fl mianbao_tit">北美收藏文化之旅</a>
        ...
        <div class="sjnew_box nr_box clear">
          ...
          <div class="sczx_nr">
            ...
            <p><img src="http://admin.wswhly.com/wswhly/ueditor/jsp/upload/20140911/42681410426722733.JPG"/></p>
