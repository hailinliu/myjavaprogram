...
<html>
  <head>
    ...
    <title>华豫快讯_卫视文化乐园-华豫之门官方网站</title>
...
<div class="main_box clear">
  ...
  <div class="mian_right clear">
     <div class="scxy_pic" style="background:url(../images/hykx_bg.jpg)"><span class="bread_nav">当前位置：首页<span class="jt">></span>华豫快讯<span class="jt">></span><a href="#" target="_blank">${news.title}</a></span></div>
     <div class="title_box">
       <h3>${news.title}</h3>
       <ul class="title_list">
    ...
    <div class="about_xy" style="background:url(../images/xgkx_bg.jpg)"></div>
