...
<!--<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" ""http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 <html>
  ...
  <meta name="description" content="卫视文化乐园-河南卫视《华豫之门》官方网站，提供鉴定海选报名、艺术品收藏品展览拍卖、收藏资讯和鉴定收藏知识，藏品在线交易平台，网络拍卖，供藏友相互交流交易">
	<link href="http://www.wswhly.com/images/favicon.ico" mce_href="http://www.wswhly.com/images/favicon.ico" rel="bookmark" type="image/x-icon" />
	<link href="http://www.wswhly.com/images/favicon.ico" mce_href="http://www.wswhly.com/images/favicon.ico" rel="icon" type="image/x-icon" />
	<link href="http://www.wswhly.com/images/favicon.ico" mce_href="http://www.wswhly.com/images/favicon.ico" rel="shortcut icon" type="image/x-icon" />
-->
 ...
 <!--head and nav-->
    ...
    <div class="nav_menu">
        ...
        <ul class="nav_box" style="">
           ...
           <li class="zx">
            <a href="http://www.wswhly.com/yclots/getYclotsListByspecialID" target="_blank">拍卖会</a>
           </li>
           <li class="zx">
        ...
        <div class="menu_content">
          <ul style="padding-top:16px;">
            ...
            <li class="menu_spt2">
              <p><a href="<c:url value='/baibaoindex/BaiBao_getIndex'/>" target="_blank">我要开店</a></p>
            ...
            <li>
              <p><a href="<c:url value='/onlinepic/gotoonlinepicindex'/>" target="_blank">图片鉴定</a></p>
              <p><a href="http://www.wswhly.com/yclots/getYclotsListByspecialID?specialID=59&jgid=5&pmhid=8" target="_blank">保真估值</a></p>
