...
<jsp:include page="../banner/banner.jsp"></jsp:include>
    ...
    <div class="qjsj_left fl">
        <div class="qj_video_head">
            ...
            <span class="fl">&nbsp;>&nbsp;</span>
            <a href="<c:url value='/redirect?p=flagship/qjsj_tuzhan'/>" target="_blank" class="fl">商家图展</a>
        ...
        <div class="qj_picss">
          ...
          <ul class="fl qj_pic_lit">
            <li>
              <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">
                  <img src="<c:url value='/images/flagship/0006.jpg'/>" alt="" />
              </a>
              <div class="tuzhan_pic">
                  <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">111111111111111111111111111111111111111111111111</a>
              </div>
            </li>
            <li>
              <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">
                  <img src="<c:url value='/images/flagship/0002.jpg'/>" alt="" />
              </a>
              <div class="tuzhan_pic">
                  <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">111111111111111111111111111111111111111111111111</a>
              </div>
            ...
            <li>
              <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">
                  <img src="<c:url value='/images/flagship/0007.jpg'/>" alt="" />
              </a>
              <div class="tuzhan_pic">
                  <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">111111111111111111111111111111111111111111111111</a>
              </div>
          ...
          <ul class="fl qj_pic_lit qj_pic_lit2">
            <li>
              <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">
                  <img src="<c:url value='/images/flagship/0004.jpg'/>" alt="" />
              </a>
              <div class="tuzhan_pic">
                  <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">111111111111111111111111111111111111111111111111</a>
              </div>
            ...
            <li>
              <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">
                  <img src="<c:url value='/images/flagship/0005.jpg'/>" alt="" />
              </a>
              <div class="tuzhan_pic">
                  <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">111111111111111111111111111111111111111111111111</a>
              </div>
          ...
          <ul class="fl qj_pic_lit">
            ...
            <li>
              <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">
                  <img src="<c:url value='/images/flagship/0003.jpg'/>" alt="" />
              </a>
              <div class="tuzhan_pic">
                  <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">111111111111111111111111111111111111111111111111</a>
              </div>
            ...
            <li>
              <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">
                  <img src="<c:url value='/images/flagship/0001.jpg'/>" alt="" />
              </a>
              <div class="tuzhan_pic">
                  <a href="<c:url value='/redirect?p=flagship/qjsj_lookimg'/>" target="_blank">111111111111111111111111111111111111111111111111</a>
              </div>
