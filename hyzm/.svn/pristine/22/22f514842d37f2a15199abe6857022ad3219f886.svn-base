  ...
  <div class="mian_left clear">
    ...
    <div class="zx_box clear">
       ...
       <div class="zx_nr">
         ...
         <div class="tu_pic">
            <a href="http://www.wswhly.com/collection/getCollection?id=1499&userid=">
                <img src="http://admin.wswhly.com/wswhly/collection/small/822bfdec-e301-4f63-a9b7-f96c0519b384.JPG" alt="龙泉鬲式炉" />
            </a>
            <p>
                <a href="http://www.wswhly.com/collection/getCollection?id=1499&userid="/>龙泉鬲式炉
                </a>
            </p>
         </div>
         <div class="hb_down"><p class="hb_left fl"><img src="<c:url value='/images/bottom_left.jpg'/>" alt=""/></p><p class="hb_right fr"><img src="<c:url value='/images/hb_bottom_right.jpg'/>" alt=""/></p></div>
        </div>
        <!-- <%=PropertiesUtil.getPropertiesValue("collectionurl")%>small/${col.imgurl} -->
    </div>

  </div><!--left end-->

  <div class="mian_right clear">
     <div class="sczx_pic"><span class="bread_nav">当前位置：首页<span class="jt">></span>收藏资讯<span class="jt">></span><a href="#">${news.stylename}</a></span></div>
     <div class="title_box">
       <h3>${news.title}</h3>
       <ul class="title_list">
