...
<html>
  <head>
    ...
    <title>华豫藏品_卫视文化乐园-华豫之门官方网站</title>
  ...
  <script type="text/javascript" src="<c:url value='/js/jquery_date.js'/>"></script>
	<meta name=keywords content="华豫藏品">
	<meta name=description content="卫视文化乐园-华豫之门官方网站，华豫藏品">
...
<div class="main_box clear">
  ...
  <div class="mian_right clear" style="position:relative">
     <div class="hycp_pic"><span class="bread_nav">当前位置：首页<span class="jt">></span>华豫藏品<c:if test="${not empty typename}"><span class="jt">></span><a target="_blank" href="#">${typename}</a></c:if></span></div>

      <div class="hycp_btn1">
       	<input id="allpfe" type="button" class="btns btn_href" onclick='window.location.href="<c:url value='/collection/getHycp?typeid=1&styleid=0'/>"' value="全部类别">
     	 <c:forEach items="${liststyle}" var="style" varStatus="cdn">
        	 <input id="${style.id}" name="styNmae" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getHycp?typeid=1&styleid=${style.id}&pricearea=${pricearea}'/>"' value="${style.name}">
         </c:forEach>
      </div>
      <!-- 按照价格区间 -->
       <div class="hycp_btn1 money_btn1" style="margin-top:0";>
       		<input id="allpmon" type="button" date-role="-1" class="btns btn_href" onclick='window.location.href="<c:url value='/collection/getHycp?typeid=1&styleid=${type}&pricearea=-1'/>"' value="全部价格">
        	<input id="" date-role="0" name="monNmae" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getHycp?typeid=1&styleid=${type}&pricearea=0'/>"' value="5万以内">
            <input id="m2" date-role="1" name="monNmae" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getHycp?typeid=1&styleid=${type}&pricearea=1'/>"' value="5至10万">
            <input id="m2" date-role="2" name="monNmae" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getHycp?typeid=1&styleid=${type}&pricearea=2'/>"' value="10至20万">
            <input id="m2" date-role="3" name="monNmae" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getHycp?typeid=1&styleid=${type}&pricearea=3'/>"' value="20至50万">
            <input id="m2" date-role="4" name="monNmae" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getHycp?typeid=1&styleid=${type}&pricearea=4'/>"' value="50至100万">
            <input id="m2" date-role="5" name="monNmae" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getHycp?typeid=1&styleid=${type}&pricearea=5'/>"' value="100万以上">
    ...
    <c:if test="${count / pageSize > 0}">
     <div class="paging clear">
        <pg:pager url="../collection/getHycp" items="${count}" maxPageItems="9" maxIndexPages="5">
