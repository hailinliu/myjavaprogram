...
<div class="main_box clear jgxq">
	...
	<div class="pmjg_right fr">
		...
		<div class="jg_right_center" style="text-align:center;">
			<!-- 拍卖视频 -->
			<div class="jg_right_bottom4" style="margin-top:0;"></div>
			<div class="title_box">
		       <h3>1111111111</h3>
		       <ul class="title_list">
		           <li>时间：11111</li>     
			...
			<div class="nr_box clear">
		       <p class="line"></p>
		        <div class="sczx_nr" style="text-align:center;">
		            <p>11111111111111111111111111111111111111111111</p>
					<p>
						<img src="<c:url value='/images/getAuction/exmpleVideo.png'/>" />
					</p>
		         </div>
		       <p class="line"></p>   
		     </div>
