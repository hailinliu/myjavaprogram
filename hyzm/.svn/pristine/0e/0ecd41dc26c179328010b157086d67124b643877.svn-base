...
//			if (url.indexOf("/index") > -1 || url.indexOf("/getOneNews") > -1 || url.indexOf("/getCollectionus") > -1 || url.indexOf("getVideo") > -1 || url.indexOf("getProficient") > -1) {
//				url = url.replaceAll(PropertiesUtil.getPropertiesValue("pcurl"), PropertiesUtil.getPropertiesValue("mobileurl"));
