    ...
    <div class="qjsj_left fl" style="width: 810px;">
        ...
        <div class="sjnew_box nr_box clear">
        	...
        	<div class="sczx_nr">
        		...
        		<p><iframe class="edui-faked-video" frameborder="0" src="http://v.qq.com/iframe/player.html?vid=k0137eqq388&amp;tiny=0&amp;auto=0" allowfullscreen="" width="800" height="600" style="margin-left: -28px;"></iframe></p>
