...
<html>
  <head>
	...
	<meta name=keywords content="会员藏品，${activity.name}">
	<meta name=description content="卫视文化乐园-华豫之门官方网站会员藏品-${activity.name}">
...
<div class="main_box clear">
   <div class="scpjs_pic">
      <span class="bread_nav">当前位置：首页<span class="jt">></span><a href="<c:url value='/vote/vipCollectionList'/>">会员藏品区</a> <span class="jt">></span><span class="jt">${activity.name}</span></span>
   </div>
   ...
   <!-- <div style="text-align:right;margin-bottom:20px;" >
   		...
   		<c:if test="${activity.updatenum < 3}"><a href="javascript:void(0)" class="bianji box_block">我要补充</a></c:if>
   </div>
