...
<html>
  <head>
    <title>会员中心_卫视文化乐园-华豫之门官方网站</title>
	...
	<meta name=keywords content="会员信息，会员中心">
	<meta name=description content="卫视文化乐园-华豫之门官方网站会员中心">
...
<div class="main_box clear">
  ...
  <div class="user_right fr clear">
     ...
     <div class="onuser">
       <div class="hb2_left fl"><p class="hb_top"><img src="<c:url value='/images/hb1_left.jpg'/>" /></p><p class="hb_bottom"><img src="<c:url value='/images/hb2_left.jpg'/>" /></p></div>
         ...
         <div class="onuser_nr fl">
         	...
         	<div class="onuser_nr_right">
         		<div class="sj_qx">
         			<p class="hy_sj"><a href="<c:url value='/mine/gotovip'/>">会员升级</a></p>
         		</div>
                <div class="link">
       ...
       <div class="hb2_right fr"><p class="hb_top"><img src="<c:url value='/images/hb1_right.jpg'/>" alt="" /></p><p class="hb_bottom"><img src="<c:url value='/images/hb2_right.jpg'/>" alt="" /></p></div>
     </div>

  	<div class="onuser_tit">个人信息<span class="line">--</span><span>参与《华豫之门》鉴宝海选活动网上报名，必须填写实名信息。</span></div>
     <div class="onuser_cont">
       <img src="<c:url value='/images/touxiang.jpg'/>" alt=""/>
     ...
     <div class="onuser_wz">
     	<!-- <span><a href="<c:url value='/redirect?p=mine/phonepass'/>" class="resetpp">修改个人信息</a></span> -->
     	<span style="margin-left:290px;">*完善的实名信息有助于提高您的账户安全</span>
     </div>
     ...
     <div class="fw_jb"><p><a href="http://www.wswhly.com/mine/gotovip">查看会员级别服务及收费标准</a></p></div>
      ...
      <div id="easyDialogWrapper" class="easyDialog_wrapper">
		...
		<!-- ////////////////////// -->
				<ul class="chang_list1">
			        ...
			        <!-- 修改姓名发送验证码按钮 -->
			        <!-- <div style="height:30px;padding-left:196px;">
			        	<div class="tisxx" id="newrealnamesendsms" ><a class="block1" href="javascript:sendsms('newrealname','7')" style="display:block;width:93px;"><img src='<c:url value='/images/sen_button.jpg'/>' align='middle' alt=""/></a></div>
			        </div>
      ...
      <div id="easyDialogWrapper" class="easyDialog_wrapper">
              ...
              <h4 class="easyDialog_title" id="easyDialogTitle" style="cursor: move;">
	              ...
	              <ul class="chang_list1">
		        	...
		        	<!-- <div style="padding-left:196px;">
		        		<div class="tisxx" style="top:123px;" id="oldmobilesendsms" ><a class="block1" href="javascript:oldmobilesendsms()" style="display:block;width:93px;"><img src='<c:url value='/images/sen_button.jpg'/>' align='middle' alt=""/></a></div>
		        	</div>
			        <ul class="chang_list1">
			        <li class="mc">手机验证码：</li>
				      <li><input type="text" id="oldmobilecode" maxlength="6" class="input_out"  type="text" onfocus="this.className='input_on';this.onmouseout=''" onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};" onmousemove="this.className='input_move'" onmouseout="this.className='input_out'" style="width:110px;" /></li>
						...
						<li class="codxx" style="margin-left:8px;" id="oldmobilecodep"></li>
		...
		<!-- ////////////////////// -->
				<ul class="chang_list1">
			       ...
			       <div style="padding-left:196px;">
			       		<div class="tisxx" id="newmobilesendsms" ><img src='<c:url value='/images/send_pic2.jpg'/>' align='middle' alt=""/></div>
			       </div>
				        <ul class="chang_list1">
				        <li class="mc">手机验证码：</li>
		...
		<!-- ////////////////////// -->
				<ul class="chang_list1" style="margin-left:65px;">
			        ...
			        <!-- <div style="margin-left:176px;">
			        	 <div class="tisxx" id="newemailsendsms" ><a class="block1" href="javascript:sendsms('newemail','5')" style="display:block;width:93px;"><img src='<c:url value='/images/sen_button.jpg'/>' align='middle' alt=""/></a></div>
			        </div>
      ...
      <div id="easyDialogWrapper" class="easyDialog_wrapper">
		...
		<!-- ////////////////////// -->
				<ul class="chang_list1">
			        ...
			        <!-- <div style="padding-left:196px;">
			        	<div class="tisxx" id="newidcardsendsms" ><a class="block1" href="javascript:sendsms('newidcard','8')" style="display:block;width:93px;"><img src='<c:url value='/images/sen_button.jpg'/>' align='middle' alt=""/></a></div>
			        </div>
...
<div class="forgebox5_1">
   ...
   <div class="find_bt"><span class="bt_wz">修改职业</span><span class="off5_1"><a href="#" onclick="">关闭</a></span></div>
       ...
       <c:if test="${not empty CurrentSession.job}">
		    ...
		    <ul class="list2_box">
		      <li class="mc">&nbsp;</li>
		      <li id="newjobsendsms"><a href="javascript:sendsms('newjob','8')"><img src='<c:url value='/images/sen_button.jpg'/>' align='middle' alt=""/></a></li>
		    </ul>
	     </c:if>
      ...
      <div id="easyDialogWrapper" class="easyDialog_wrapper">
		...
		<!-- ////////////////////// -->
			    ...
			    <!-- <div style="padding-left:160px;">
			    	<div class="tisxx" id="newaddresssendsms" ><a class="block1" href="javascript:sendsms('newaddress','10')" style="display:block;width:93px;"><img src='<c:url value='/images/sen_button.jpg'/>' align='middle' alt=""/></a></div>
			    </div>
