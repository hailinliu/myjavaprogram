...
<div class="main_box clear jgxq">
	...
	<div class="pmjg_right fr">
		<div class="jg_right_top">
			...
			<a href="<c:url value='/redirect?p=Auction/getAuctionsinfo02'/>" >相关资讯</a>
...
这就是拍卖作为一种行业最初在世界上出现的情形。由此，也诞生了世界上最古老的拍卖行——苏富比（又名索斯比）。
		...
		<!-- 拍卖预展 -->
		<div class="jg_right_bottom2"></div>
		<ul class="jg_right_pm">
			<li>
				<a href="<c:url value='/redirect?p=Auction/getAuctionOneyuzhan'/>" target="_blank">
		...
		<!-- 拍卖结果-->
		<div class="jg_right_bottom3"></div>
		<ul class="jg_right_pm">
			<li>
				<a href="<c:url value='/redirect?p=Auction/getAuctionOnejieguo'/>" target="_blank">
					<img src="<c:url value='/images/getAuction/jg_pic1.jpg'/>"/>
				</a>
				<p>
					<a href="<c:url value='/redirect?p=Auction/getAuctionOnejieguo'/>" target="_blank">
		...
		<!-- 拍卖视频-->
		<div class="jg_right_bottom4"></div>
		<ul class="jg_right_pm">
			<li>
				<a href="<c:url value='/redirect?p=Auction/getAuctionOneVideo'/>" target="_blank">
					<img src="<c:url value='/images/getAuction/jg_pic1.jpg'/>"/>
				</a>
				<p>
					<a href="<c:url value='/redirect?p=Auction/getAuctionOneVideo'/>" target="_blank">
