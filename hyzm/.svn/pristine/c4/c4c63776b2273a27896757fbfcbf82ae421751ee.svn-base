...
<jsp:include page="../banner/banner.jsp"></jsp:include>
    ...
    <div class="qjsj_left fl" style="width: 810px;">
        <div class="qj_video_head">
            ...
            <span class="fl">&nbsp;>&nbsp;</span>
            <a href="<c:url value='/redirect?p=flagship/qjsj_video'/>" target="_blank" class="fl">商家视频</a>
            <span class="fl">&nbsp;>&nbsp;</span>
            <a href="<c:url value='/redirect?p=flagship/qjsj_video'/>" target="_blank" class="fl mianbao_tit">苏富比高级董事访谈 拍卖适应时代潮</a>
        ...
        <div class="sjnew_box nr_box clear">
        	<div class="title_box">
		       <h3>苏富比高级董事访谈</h3>
		       <ul class="title_list">
		           <li>时间：2014-09-13 17:34:3</li>
		           <li>点击：466</li>
		           <li>标签：华豫之门 收藏品 拍卖 苏富比</li>
		       </ul>
		    </div>
		    <p class="line"></p>
        	...
        	<div class="sczx_nr">
              ...
              <p><object codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="800" height="600"><param name="_cx" value="21166"><param name="_cy" value="15875"><param name="FlashVars" value=""><param name="Movie" value="http://admin.wswhly.com/wswhly/video/vcastr22.swf?vcastr_file=http://pic.wswhly.com:8080/fileManager/userFiles/video/2014gw/sufubi0912.flv"><param name="Src" value="http://admin.wswhly.com/wswhly/video/vcastr22.swf?vcastr_file=http://pic.wswhly.com:8080/fileManager/userFiles/video/2014gw/sufubi0912.flv"><param name="WMode" value="Window"><param name="Play" value="0"><param name="Loop" value="-1"><param name="Quality" value="High"><param name="SAlign" value="LT"><param name="Menu" value="0"><param name="Base" value=""><param name="AllowScriptAccess" value=""><param name="Scale" value="NoScale"><param name="DeviceFont" value="0"><param name="EmbedMovie" value="0"><param name="BGColor" value=""><param name="SWRemote" value=""><param name="MovieData" value=""><param name="SeamlessTabbing" value="1"><param name="Profile" value="0"><param name="ProfileAddress" value=""><param name="ProfilePort" value="0"><param name="AllowNetworking" value="all"><param name="AllowFullScreen" value="true"><param name="AllowFullScreenInteractive" value="false"><param name="IsDependent" value="0"><embed src="http://admin.wswhly.com/wswhly/video/vcastr22.swf?vcastr_file=http://pic.wswhly.com:8080/fileManager/userFiles/video/2014gw/sufubi0912.flv" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="800" height="600"></object></p>
         </div>
		...
		<!-- 视频简介 -->
        <div class="video_jxs">
            <span class="">视频简介：</span>

				受访者：汪涛，博士，苏富比高级董事，中国瓷器及工艺品部门主管。苏富比位于纽约市约克大道1334号。
            ...
            <li class="no_margin_lf">
              ...
              <div class="lit_video">
                <a href="<c:url value='/redirect?p=flagship01/qjsj_onevideo03'/>" target="_blank">
                  <img src="<c:url value='/images/flagship/140913.jpg'/>" alt="" width="195" height="162">
              </a>
              </div>
              <div class="video_tit_box2">
              </div>
              <p class="video_tit2">
                    <a href="<c:url value='/redirect?p=flagship01/qjsj_onevideo03'/>" target="_blank">苏富比高级董事访谈</a>
              </p>
            </li>
            <li>
              <div class="qj_video_top"></div>
              ...
              <div class="lit_video">
                <a href="<c:url value='/redirect?p=flagship01/qjsj_onevideo01'/>" target="_blank">
                  <img src="<c:url value='/images/flagship/1409172.jpg'/>" alt="" width="195" height="162">
              </a>
              </div>
              <div class="video_tit_box2">
              </div>
            ...
            <li class="no_margin">
              ...
              <div class="lit_video">
                <a href="<c:url value='/redirect?p=flagship01/qjsj_onevideo02'/>" target="_blank">
                  <img src="<c:url value='/images/flagship/140915.jpg'/>" alt="" width="195" height="162">
              </a>
              </div>
              <div class="video_tit_box2">
              </div>
            ...
            <li>
              ...
              <div class="lit_video">
                <a href="<c:url value='/redirect?p=flagship01/qjsj_onevideo04'/>" target="_blank">
                  <img src="<c:url value='/images/flagship/140911.jpg'/>" alt="" width="195" height="162">
              </a>
              </div>
              <div class="video_tit_box2">
              </div>
