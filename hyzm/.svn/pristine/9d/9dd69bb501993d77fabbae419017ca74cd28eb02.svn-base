...
<html>
  <head>
    ...
    <title>网上报名_卫视文化乐园-华豫之门官方网站</title>
  ...
  <meta name=keywords content="网上报名，参加报名">
  <meta name=description content="卫视文化乐园-华豫之门官方网站，网上报名">
...
function Enroll() {
  ...
  alert("您的余额不足，请充值");
  window.open("<c:url value='/redirect?p=mine/recharge1'/>");
  } else {
...
<div id="bmover" class="bm_over">
    <h3 style="font-size:50px;color:#F6ED10;padding-top:40%;">敬请期待！O(∩_∩)O</h3>
</div>
