...
<jsp:directive.page import="com.alipay.api.AlipayClient"/>
<jsp:directive.page import="com.alipay.api.DefaultAlipayClient"/>
<jsp:directive.page import="com.alipay.api.request.AlipaySystemOauthTokenRequest"/>
<jsp:directive.page import="com.alipay.api.response.AlipaySystemOauthTokenResponse"/>
...
<!--main style end-->  
 <% 
      try{
     	 AlipayClient client = new DefaultAlipayClient("https://openapi.alipay.com/gateway.do","top.23096573", "", "json");
    	AlipaySystemOauthTokenRequest req=new AlipaySystemOauthTokenRequest();
		//根据授权码取授权令牌
    	req.setGrantType("authorization_code");
		//授权码，用户对应用授权后得到。
    	req.setCode(request.getParameter("code"));
    	AlipaySystemOauthTokenResponse s = client.execute(req); 
    	String userid=s.getAlipayUserId();
    	String nick="zfb";
    	if(userid.length()>=8){
    	 nick+=userid.substring(0,7);
    	}
      %>
      <script type="text/javascript">
				 $(function(){
		   			$('#username').val('<%=nick%>'+Math.floor(Math.random()*10000000));
					$('#openId').val('zfb_<%=s.getAlipayUserId()%>');
					checkopenId('zfb_<%=s.getAlipayUserId()%>');
				 });	
