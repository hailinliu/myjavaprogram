...
<html>
  <head>
    ...
    <title>珍宝台藏品_卫视文化乐园-华豫之门官方网站</title>
  ...
  <meta name=keywords content="珍宝台藏品">
  <meta name=description content="卫视文化乐园-华豫之门官方网站，珍宝台藏品">
...
<div class="main_box clear">
  ...
  <div class="mian_left clear">
     ...
     <div class="scpk_box clear">
      <ul class="scpk_list">
           ...
           <li>
               <a href="<c:url value='/collection/getZjcp?typeid=3&styleid=0'/>
               ">专家推荐藏品
              </a>
           </li>
  ...
  <div class="mian_right clear" style="position:relative">
     <div class="zbcp_pic"><span class="bread_nav">当前位置：首页<span class="jt">></span>珍宝台藏品<c:if test="${not empty typename}"><span class="jt">></span><a target="_blank" href="#">${typename}</a></c:if></span></div>

      <div class="hycp_btn1">
         <input id="allpfe" type="button" class="btns btn_href" onclick='window.location.href="<c:url value='/collection/getZbcp?typeid=2&styleid=0'/>"' value="全部类别">
         <c:forEach items="${liststyle}" var="style" varStatus="cdn">
         <input id="${style.id}" name="styNmae" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getZbcp?typeid=2&styleid=${style.id}&pricearea=${pricearea}'/>"' value="${style.name}">
         </c:forEach>
      </div>
      <!-- 按照价格区间 -->
      <div class="hycp_btn1 money_btn1" style="margin-top:0";>
        <input id="allpmon" date-role="-1" type="button" class="btns btn_href" onclick='window.location.href="<c:url value='/collection/getZbcp?typeid=2&styleid=${type}&pricearea=-1'/>"' value="全部价格">

           <input id="m1" name="monNmae" date-role="0" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getZbcp?typeid=2&styleid=${type}&pricearea=0'/>"' value="5万以内">
            <input id="m2" name="monNmae" date-role="1" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getZbcp?typeid=2&styleid=${type}&pricearea=1'/>"' value="5至10万">
            <input id="m2" name="monNmae" date-role="2" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getZbcp?typeid=2&styleid=${type}&pricearea=2'/>"' value="10至20万">
            <input id="m2" name="monNmae" date-role="3" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getZbcp?typeid=2&styleid=${type}&pricearea=3'/>"' value="20至50万">
            <input id="m2" name="monNmae" date-role="4" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getZbcp?typeid=2&styleid=${type}&pricearea=4'/>"' value="50至100万">
            <input id="m2" name="monNmae" date-role="5" type="button" class="btns" onclick='window.location.href="<c:url value='/collection/getZbcp?typeid=2&styleid=${type}&pricearea=5'/>"' value="100万以上">
       ...
       <c:forEach items="${collectionList}" var="collection" varStatus="cdn">
          <c:if test="${cdn.count % 3 == 1}">
            ...
            <a href="<c:url value='/collection/${collection.id}.dhtml'/>" target="_blank">
                  ...
                  <p class="" style="margin-top:15px;display:block;">
    ...
    <c:if test="${count / pageSize > 0}">
     <div class="paging clear">
        <pg:pager url="../collection/getZbcp" items="${count}" maxPageItems="9" maxIndexPages="5">
