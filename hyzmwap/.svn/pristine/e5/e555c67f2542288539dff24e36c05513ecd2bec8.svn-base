...
public class MchatFilterUtil {
	...
	@SuppressWarnings("unchecked")
	private static boolean getCountString() {
		// TODO:加载过滤词库
		String[] filterWordList = new String[] {"你妈B", "你妈", "我操你妈","QQ","TMD","妈的","傻逼"," 妈逼","靠","操","发票","习近平","迷药","做爱","办证","共产党"
			,"天安门 ","色情","口交","情色","阴茎","阴毛","黄色","成人","妓女","婊子","免费","联系","电话","A片","短信","手枪","mb","sb","md","cnm","nnd",
            "tmd","奶奶的","薛","xue","骗","忽悠"
		};
        boolean falg=false;
