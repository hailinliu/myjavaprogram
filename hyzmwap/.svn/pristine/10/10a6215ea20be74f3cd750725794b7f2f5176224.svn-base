...
<html>
  <head>
	...
	function modify(){
		if($('#idcard').val().length == 0){
			$('#idcardp').empty().append("输入身份证格式错误");
			return false;
		}
		...
		$.ajax({type: "POST",
			...
			data: {idcard:$('#idcard').val(),d:new Date().getTime()},
  ...
  <div data-role="header">
  	...
  	<div data-role="content">
			<input type="text" placeholder="新身份证" name="idcard" id="idcard"  maxlength="20"/>
			<p style="color: red" id="idcardp"></p>
