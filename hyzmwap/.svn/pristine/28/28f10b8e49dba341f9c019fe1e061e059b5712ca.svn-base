...
var citycode='';//市
var provincecode='';//省
var dicaddressurl='http://172.19.80.1/hyzmwap/getDicaddress?s='+Math.random()+'&parentcode=';
 ...
 var con= "<select style='width:100px' id='provincecode' name='provincecode' onchange='getCity(this.options[this.selectedIndex].value)'> <option value=''>省</option>";
 	$.ajax({
        type:'post',
        url:dicaddressurl+"0",
 ...
 if(provincecode_c==''){$("#cityspan").html("<select><option value=''>市</option></select>");$("#countyspan").html("<select><option value=''>县</option></select>");return;}
 var con= "<select  style='width:100px'id='citycode' name='citycode' onchange='getCounty(this.options[this.selectedIndex].value)'> <option value=''>市</option>";
 	$.ajax({
        type:'post',
 ...
 var CountyjsonData ="";
  ...
  if(citycode_c==''){$("#countyspan").html("<select id='countycode' name='countycode'><option value=''>县</option></select>");return;}
   var con= "<select style='width:100px' id='countycode' name='countycode'> <option value=''>县</option>";
 	$.ajax({
        type:'post',
