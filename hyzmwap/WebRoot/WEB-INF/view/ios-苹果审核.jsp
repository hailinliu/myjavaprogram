...
<c:if test="${ not empty CurrentSession.username}">
	...
	<div id="nav" data-role="nav-bar">
		<ul>
			...
			<li>
				<a onclick="location.href='http://wap.wswhly.com:6080/redirect?p=gotohyzm/gotohyzm'" style="background-position:90% 0%">我要上华豫</a>
			</li>
			<li>
				<a onclick="location.href='http://wap.wswhly.com/redirect?p=cjfy'" style="background-position:13% 33%">藏界风云</a>
			</li>
			<li>
