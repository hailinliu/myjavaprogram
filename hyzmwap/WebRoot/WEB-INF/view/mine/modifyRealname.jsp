...
<html>
  <head>
	...
	function modify(){
		...
		if($('#realname').val().length == 0){
			$('#realnamep').empty().append("请输入真实姓名");
			return false;
		}
		...
		$.ajax({type: "POST",
			...
			data: {realname:$('#realname').val(),d:new Date().getTime()},
  ...
  <div data-role="header">
  	...
  	<div data-role="content">
			<input type="text" placeholder="新姓名" name="realname" id="realname"  maxlength="16"/>
			<p style="color: red" id="realnamep"></p>
