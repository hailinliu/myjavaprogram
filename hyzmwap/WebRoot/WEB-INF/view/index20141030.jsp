...
<html>
  ...
  <div data-role="page" class="w_box" style="">
	 ...
	 <div class="ui-grid-b" style="cursor: pointer;" onclick="location.href='http://wap.wswhly.com/news/getOneNews?id=1955'"><img src="<c:url value='/images/vip/apptu3.jpg'/>" width="100%" style="display: block;"/></div>
  	...
  	<div class="ui-grid-b">
	    ...
	    <div class="ui-block-c" onclick="location.href='<c:url value="/mine/gotoenroll"/>'" data-ajax="false" style="cursor: pointer;"><div class="ui-bar ui-bar-a" id="icon-a" style=""><img src="images/icon/calendar.png" style=""><br />海选报名</div></div>
	</div>
  	<div class="ui-grid-b">
