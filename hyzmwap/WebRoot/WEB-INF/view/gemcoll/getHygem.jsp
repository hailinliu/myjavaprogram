...
#Header { background: #000; height: 42px; border-bottom: 1px solid #ccc; text-align: center;}
...
<div>
		  ...
		  当前票数：${activity.votenum}票 &nbsp;&nbsp;&nbsp;<input type="button" id="but" value="投票" style="background:#A10005;height:30px;padding:0 10px;border-radius:3px;cursor:pointer;font-size:14px;color:#fff;" onclick="vote(${activity.id});"/>
		  <hr/>
