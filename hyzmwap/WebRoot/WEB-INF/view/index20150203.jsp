...
<%--	}--%>
  ...
  <div data-role="page" class="w_box" style="">
	...
	<div data-role="content" class="ui-content">
	 <a style="cursor: pointer; display:blcok;" onclick="location.href='<c:url value="/redirect?p=baibaoxiang/bbx"/>'">
	 <img src="<c:url value='/images/ads/wap-banner1231.jpg'/>" alt="" id="bbxLink" width="100%" >
...
<!--    <div class="ui-grid-b">
	    <div class="ui-block-a"  data-ajax="false" style="cursor: pointer;" id="bbxLink"><div class="ui-bar ui-bar-a" id="icon-a" style=""><img src="images/icon/goto_hy.png" style=""><br />百宝箱</div></div>
	    <div class="ui-block-b" onclick="location.href='<c:url value="/redirect?p=baibaoxiang/shopList"/>'" data-ajax="false" style="cursor: pointer;"><div class="ui-bar ui-bar-a" id="icon-a" style=""><img src="images/icon/zhengjiling.png" style=""><br />商家列表</div></div>
	    <div class="ui-block-c" onclick="location.href='<c:url value="/redirect?p=baibaoxiang/cpList"/>'" data-ajax="false" style="cursor: pointer;"><div class="ui-bar ui-bar-a" id="icon-a" style=""><img src="images/icon/collections.png" style=""><br />藏品列表</div></div>
	</div>-->
...
<!-- <div data-role="footer">
  ...
  <div data-role="page" id="jingpin" data-theme="a">
	<jsp:include page="head/header.jsp?name=精品推荐"></jsp:include>
	 ...
	 <a href="#jingpin" class="ui-shadow ui-btn ui-corner-all" data-rel="back">返回</a>
  </div>
