...
public class ImageUtil {
	...
	public static void imageZip(String imgname, String path, int maxWidth,
			int maxHeight) {
		ImageUtil is = new ImageUtil();
		try {
			String oldsrc = path + File.separatorChar + imgname + ".jpg";
			String newsrc = path + File.separatorChar + "small" + File.separatorChar + imgname + ".jpg";
