...
function uploadSuccess(file, serverData) {
	try {
	    ...
	    $('#imagelistid').empty().append("<img src='../video/"+$('#videoid').val()+"'/>");
...
function formsubmit(){
	$('#addvideoform').form('submit', {
		url: "<c:url value='/video/addvideo'/>",
		onSubmit: function() {
			return $(this).form('validate');
		},
		success: function(data) {
			if(data == "0000"){
				$.messager.alert('提示', "添加视频成功！", 'info',function(){
  ...
  <body>
	...
	<form id="addvideoform" method="post">
	   ...
	   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" style="font-size: 12px;padding: 5px;background-color: #efefef;border:1px solid #A4BED4;">
			<tr>
				<td valign="baseline">视频名称:<input name="title" class="easyui-validatebox" data-options="required:true"/></td>
				<td valign="baseline">
				...
				:<input name="proficient" class="easyui-validatebox" data-options="required:true"/></td>
			</tr>
			<tr>
