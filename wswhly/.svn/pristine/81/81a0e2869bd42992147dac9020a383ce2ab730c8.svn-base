...
UE.plugins['video'] = function (){
    ...
    function creatInsertStr(url,width,height,id,align,toEmbed){
        // 56 视频
        var arr_56 = new Array();
        arr_56 = url.split("v_");
        var url_56 = arr_56[1].substring(0,arr_56[1].length-4);
        ...
        return  !toEmbed ?
                ...
                :
                '<iframe class="edui-faked-video" frameborder=0 src="http://www.56.com/iframe/' + url_56 + '" allowfullscreen="" width="' + width  + '" height="' + height  + '" style="float:' + align + ';"></iframe>';

                    // '<embed src="http://www.ckplayer.com/ckplayer6.1/ckplayer.swf" flashvars="f='+url+'" quality="high" width="'+ width +'" height="' + height + '" align="middle" allowScriptAccess="always" allowFullscreen="true" wmode="transparent" type="application/x-shockwave-flash"></embed>'
                    // '<embed src="http://116.255.149.172:7080/wswhly/video/vcastr22.swf?vcastr_file='+url+'" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="'+ width +'" height="' + height + '"/>';

               //  '<embed type="application/x-shockwave-flash" class="edui-faked-video" pluginspage="http://www.macromedia.com/go/getflashplayer"' +
               // ' src="' + url + '" width="' + width  + '" height="' + height  + '"'  + (align ? ' style="float:' + align + '"': '') +
               // ' wmode="transparent" play="true" loop="false" menu="false" allowscriptaccess="never" allowfullscreen="true" style="margin-left:-28px;" >';
    ...
    me.commands["insertvideo"] = {
        execCommand: function (cmd, videoObjs){
            ...
            for(var i=0,vi,len = videoObjs.length;i<len;i++){
                 vi = videoObjs[i];
                 html.push(creatInsertStr( vi.url, vi.width || 800,  vi.height || 600, id + i,null,false));
            }
