...
function formsubmit(){
	$('#addproficientform').form('submit', {
		...
		success: function(data) {
			if(data == "0000"){
				$.messager.alert('提示', "添加专家信息成功！", 'info',function(){
  ...
  <body>
    <!-- 添加专家信息 -->
	<form id="addproficientform" method="post" enctype="multipart/form-data">
	    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" style="font-size: 12px;padding: 5px;background-color: #efefef;border:1px solid #A4BED4;">
				<tr><td>专家姓名:</td><td><input name="name" class="easyui-validatebox" type="text" data-options="required:true"></td>
				<td>上传图片:</td><td><input name="imgurl" class="easyui-validatebox" type="file"></td></tr>
				<tr><td>专长:</td><td><input name="speciality" class="easyui-validatebox" type="text" data-options="required:true"></td>
				<td>称谓:</td><td><input name="appellation" class="easyui-validatebox" type="text" data-options="required:true"></td></tr>
				<tr><td>专家信息简介:</td><td>
				</td></tr>
				</table>
