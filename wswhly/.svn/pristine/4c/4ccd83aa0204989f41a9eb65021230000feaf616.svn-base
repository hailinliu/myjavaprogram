  ...
  <body>
	...
	<form id="addnewsform" method="post">
	   ...
	   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" style="font-size: 12px;padding: 5px;background-color: #efefef;border:1px solid #A4BED4;">
			<tr>
				<td>学院下属标题:<input name="title" class="easyui-validatebox" data-options="required:true"/></td>
				<td>收藏学院类型:<input name="style" class="easyui-combobox" data-options="url:'<c:url value="/news/gettypecombobox"/>?parentid=2', valueField:'id', textField:'style', panelHeight:'auto'"/></td>
